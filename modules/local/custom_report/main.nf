...
process CUSTOM_REPORT {
    ...
    script:
    """
    python3 /scripts/custom_report.py -s '*sentieonmetrics.txt' -m '*MAPD' -f '*.fastp.json' -i '$read_counts_csv' -r '$min_reads' -a '$ado_full_summary' -p 'wes' -o 'Summary' -n '$subsample_array'
